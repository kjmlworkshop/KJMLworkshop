...
BLOG_AUTHOR = "Yung-Kyun Noh"  # (translatable)
BLOG_TITLE = "The Second Korea-Japan Machine Learning Workshop"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://aisociety.kr/KJMLW2019/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "yungkyun.noh@gmail.com"
BLOG_DESCRIPTION = "Seminar homepage"  # (translatable)
